...
# ==========================================================
# SHORT ONLY – MIRROR FLOW BACKTEST DUAL LONG ĐÃ VERIFY
# ==========================================================
...
# ==========================================================
# RESAMPLE 1H – SHORT REGIME (MIRROR LONG)
# ==========================================================
...
df = pd.merge_asof(
    df.sort_values('time'),
    df_1h[['time','ema200','close','valid_regime','bars_since_break','range_low']]
...
# ==========================================================
# BACKTEST LOOP – MIRROR DUAL LONG
# ==========================================================
...
trades_df.to_csv("BACKTEST_DUAL_SHORT_TRADES.csv", index=False)

print("\n===== DUAL RANGE → TREND BACKTEST (SHORT ONLY) =====")
...
print("Saved: BACKTEST_DUAL_SHORT_TRADES.csv")
